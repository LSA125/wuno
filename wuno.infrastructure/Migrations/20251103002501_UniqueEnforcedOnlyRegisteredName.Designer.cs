...
namespace Wuno.Infrastructure.Migrations
{
    ...
    [Migration("20251103002501_UniqueEnforcedOnlyRegisteredName")]
    partial class UniqueEnforcedOnlyRegisteredName
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("wuno.domain.User", b =>
                {
                    ...
                    b.HasIndex("NameNormalized")
                        .IsUnique()
                        .HasFilter("[IsRegistered] = 1 AND [NameNormalized] IS NOT NULL AND [NameNormalized] <> ''");
